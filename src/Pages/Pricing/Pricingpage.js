        ...
        <section className="topsection">
          <div className="containerarticle">
            <div className="articlecenter">
              <h1 className="pagetitleheader">Simple pricing with no extra fees</h1>
          ...
          <Stack align='center' direction='row' className="togglebtn"
            onChange={handletoggle}>
            {!toggle ? <Text className="togglebtn1" color='green' bgColor={"rgb(242,251,249)"} >Monthly</Text> : <Text className="togglebtn1" >Monthly</Text>}

            <Switch size='md' colorScheme='green' />
            {toggle ? <Text className="togglebtn1" color='green' bgColor={"rgb(242,251,249)"} >Yearly</Text> : <Text className="togglebtn1" >Yearly</Text>}

          </Stack>


          <div className="pricingcards">
            {toggle ? (<div className="carditems">
              ...
              <div className="subtitle">
                <p >
                  <b style={{ opacity: 0.8 }}>/ user / month, starting at  5 users </b>
              ...
              <div className='actionbtns'>   <button >Try free</button></div>

            </div>) : (<div className="carditems">
              <h3 className="pricingtitle">All-in-one</h3>
          ...
          <div className="currencycontainer">
            <div className="currency-section">
              <span>
                Currency
                <select>
                  <option><FaFlagUsa />USD</option>
                  <option>EUR</option>
                  <option>GBP</option>
                  <option>AUD</option>
                  <option>CAD</option>
                  <option>  <img src="https://img.freepik.com/premium-vector/official-national-flag-united-states-america_147754-319.jpg?w=20" />INR</option>
                </select>
              </span>
            </div>
          ...
          <div className="anserDiv">
            <div className="rowanswer">
              ...
              <div className="pagesubtitle">
                <h3>Here is a list of the most frequently asked questions. Got others or some ideas? — <a href="">Contact us!</a></h3>
                <div className="imgepic">
                  <img src="https://blog-cdn.everhour.com/assets/images/new-design/illustrations/primary-illustrations/faq@2x.webp" alt="faq illustration"></img>
                </div>
            ...
            <div className="accordian">
              ...
              <Accordion allowToggle>
                <AccordionItem borderTop={"none"}>
                  <h2>
                    <AccordionButton padding="20px 32px 20px 10px" fontWeight={"500"}>
                ...
                <AccordionItem>
                  <h2>
                    <AccordionButton padding="20px 32px 20px 10px">
                      <Box flex='1' textAlign='left' fontWeight={"500"} display="flex" fontSize={"18px"} >
                ...
                <AccordionItem>
                  <h2>
                    <AccordionButton padding="20px 32px 20px 10px">
                      <Box flex='1' textAlign='left' display="flex" fontWeight={"500"} fontSize={"18px"} >
                ...
                <AccordionItem>
                  <h2>
                    <AccordionButton padding="20px 32px 20px 10px">
                      <Box flex='1' textAlign='left' fontWeight={"545"} display="flex" fontSize={"18px"} >
                        Can I change my plan later?
                      </Box>
                      <AccordionIcon />
                    </AccordionButton>
